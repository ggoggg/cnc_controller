...
void GotoX(signed long point,uint8_t speed){
    ...
    while(current_position.x!=point) {
        if (!PORTAbits.RA1) current_position.xlimit_min = 1;
        if (!PORTAbits.RA0) current_position.xlimit_max = 1;
        if (current_position.xlimit_min && PORTDbits.RD2 == 1) break;
        else if(current_position.xlimit_max && PORTDbits.RD2 == 0) break;
        else {
            delay_us(wait);
            PORTDbits.RD1 = 1;
...
void StepX(long steps, uint8_t speed, uint8_t dir){
    ...
    for(i=0;i<steps;i++){
       ...
       _delay((unsigned long)((5)*(20000000/4000000.0)));
       PORTDbits.RD1 = 0;
       if(!PORTDbits.RD2) current_position.x++;
...
void StepY(long point, uint8_t speed, uint8_t dir){
    ...
    while(current_position.y!=point){
       ...
       _delay((unsigned long)((5)*(20000000/4000000.0)));
       PORTDbits.RD3 = 0;
       if(PORTDbits.RD4) current_position.y++;
...
void StepZ(long point, uint8_t speed, uint8_t dir){
    ...
    while(current_position.z!=point){
       ...
       _delay((unsigned long)((5)*(20000000/4000000.0)));
       PORTDbits.RD5 = 0;
       if(PORTDbits.RD6) current_position.z++;
